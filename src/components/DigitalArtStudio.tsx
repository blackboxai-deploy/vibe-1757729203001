...
export default function DigitalArtStudio({ onBack }: DigitalArtStudioProps) {
  ...
  const downloadArtwork = (format: 'png' | 'jpg') => {
    const canvas = canvasRef.current;
    if (canvas) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-emerald-800 to-green-900 p-4">
      <div className="max-w-7xl mx-auto space-y-4">
        ...
        <div className="grid grid-cols-12 gap-4">
          {/* Tools Panel */}
          <Card className="col-span-3 p-4 bg-gray-900/95 border-green-700">
          ...
          {/* Canvas Area */}
          <Card className="col-span-6 p-4 bg-gray-900/95 border-green-700">
            <div className="flex justify-center">
              <canvas
                ref={canvasRef}
                className="border-2 border-gray-600 rounded cursor-crosshair bg-white"
